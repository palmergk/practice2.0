...
const UsersComponent = ({ele, userArray, altUserArray, setAltUserArray, setUserArray }) => {
    ...
    return (
             <div className='w-full border h-fit p-2 flex flex-col gap-2'>
                    ...
                    {update ?
                        <div className='ml-auto flex gap-2 items-center'>
                            ...
                            <button className='py-1 px-3 text-xs capitalize rounded-md bg-black text-white' onClick={UpdateChanges}>save</button>
                        </div>
                        :
                        <div className='ml-auto flex gap-2 items-center'>
